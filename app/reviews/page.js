...
const fetchReviews = async () => {
     const res = await fetch('https://maps.googleapis.com/maps/api/place/details/json?place_id=ChIJxzCGYLs3K4gR0hG4dhYU8mk&key=AIzaSyCefFIRmPQH-NNh_c2XOBNrHdulUH1eEfQ&fields=reviews&maxheight=10')
