...
const PianoLessonsPage = () => {
    return ( 
        <main className="piano-page">
            ...
            <section className="age px-5 lg:px-36 xl:px-52 mt-24">
            ...
            <section className="format px-5 lg:px-36 xl:px-52 bg-gray-100 py-10 mt-24">
            ...
            <section className="duration px-5 lg:px-36 xl:px-52 mt-24">
            ...
            <section className="instruments px-5 lg:px-36 xl:px-52 mt-24">
            ...
            <section className="styles px-5 lg:px-36 xl:px-52 bg-gray-100 py-10 mt-24">
