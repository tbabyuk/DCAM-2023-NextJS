...
const PostBuildAMajorScale = () => {
  return (
            ...
            <section className="px-5 lg:px-36 xl:px-64 leading-8">
                ...
                <p className="mb-10">All major scales follow a set pattern of whole steps and half steps. As long as we stick to this pattern, we will get a major scale every single time. Here is what that pattern looks like:</p>
                ...
                <p className="mb-10">The naming convention tells us the correct way to name the notes in a scale. The rule that we need to remember here is this:</p>
                <p className="font-bold text-xl text-center mb-10">DO NOT REPEAT THE SAME LETTER NAME TWICE IN A ROW</p>
            ...
            <section className="px-5 lg:px-36 xl:px-64 leading-8 mb-20">
                ...
                <p className="mb-10">One of the easiest scales to play and one that music students usually learn first is the <span className="font-bold">C Major</span> scale. The reason it's considered easy is because it only uses the white keys on the piano and has no sharps or flats. If we play every single white key from one "C" to the next "C", we will discover that it fits perfectly into our major scale formula. Let's take a look:</p>
                ...
                <p className="mb-10">Here is what the <span className="font-bold">C Major</span> scale would look like written down on the music staff.</p>
                <figure className="flex-shrink-0 flex flex-col justify-center items-center mb-10">
                    <img src="https://firebasestorage.googleapis.com/v0/b/dcam-website.appspot.com/o/blog_images%2Fbuild-a-major-scale%2Fc_maj_scale.PNG?alt=media&token=17f10ce3-24ea-4c84-a4e5-77435e5d2b6b" alt="music interval example" className="rounded-md" />
            ...
            <section className="px-5 lg:px-36 xl:px-64 leading-8 mb-20">
                ...
                <p className="mb-10">Now, let's try building another major scale - <span className="font-bold">D Major</span>. This one is slightly harder as it will include some black keys. But don't let that scare you - just focus on applying our formula! Here is what <span className="font-bold">D Major</span> will look like on the piano:</p>
                <figure className="flex-shrink-0 flex justify-center mb-10">
                ...
                <p className="mb-10">Here is what the <span className="font-bold">D Major</span> scale would look like written down on the music staff.</p>
                <figure className="flex-shrink-0 flex flex-col justify-center items-center mb-10">
            ...
            <section className="px-5 lg:px-36 xl:px-64 leading-8">
                ...
                <p className="mb-10">In the interest of variety and to take our knowledge one step further, let's build a scale that has some flats in it. <span className="font-bold">A♭ Major</span> is going to have four flats (including A♭) - can you figure out what they are?</p>
                <figure className="flex-shrink-0 flex justify-center mb-10">
                ...
                <p className="mb-6">Written in the treble clef, the <span className="font-bold">A♭ Major</span> scale would look like this:</p>
                <figure className="flex-shrink-0 flex flex-col justify-center items-center mb-10">
