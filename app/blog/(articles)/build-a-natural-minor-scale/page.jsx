...
const PostBuildANaturalMinorScale = () => {
  return (
            ...
            <section className="px-5 lg:px-36 xl:px-64 leading-8">
                ...
                <p className="mb-10">All scales follow a specific pattern of whole steps and/or half steps (a formula), and the natural minor scale is no exception. The "formula" for the natural minor scale looks like this:</p>
            ...
            <section className="px-5 lg:px-36 xl:px-64 leading-8 mb-20">
                ...
                <p className="mb-10">For our first task, let's build the <span className="font-bold">A Natural Minor</span> scale. Starting from the note "A", let's begin applying our formula:</p>
                ...
                <p className="mb-10">The quickest way to find the relative major of any minor key is to simply count up 3 half steps.</p>
                <figure className="flex-shrink-0 flex justify-center mb-10">
                ...
                <p className="mb-10">Remember that natural minor scales use the same key signature as their relative majors. Because <span className="font-bold">C Major</span> has no sharps or flats, the <span className="font-bold">A Natural Minor</span> doesn't either. So, our result looks like this:</p>
                <figure className="flex-shrink-0 flex justify-center mb-10">
                ...
                <p className="mb-10">Here is what the <span className="font-bold">A Natural Minor</span> scale looks like written down on the music staff:</p>
                ...
                <PostSubheading subheading="2. Using the Relative Major Scale" bottom="mb-6" />
                <p className="font-bold mb-10">Step 1: Find the relative major of D Minor</p>
                ...
                <p className="font-bold mb-6">Step 2: Apply the key signature of the relative major scale to the natural minor scale</p>
                <p className="mb-10">The relative major of D Minor turns out to be <span className="font-bold">F Major</span>. F Major has one flat in its key signature, which is a B♭. Therefore, <span className="font-bold">D Natural Minor</span> will also have a B♭.</p>
                <figure className="flex-shrink-0 flex justify-center mb-10">
                ...
                <p className="mb-10">Here is what the <span className="font-bold">D Natural Minor</span> scale looks like written down on the music staff:</p>
                <figure className="flex-shrink-0 flex flex-col justify-center items-center mb-10">
                ...
                <PostSubheading subheading="2. Using the Relative Major Scale" bottom="mb-6" />
                <p className="font-bold mb-10">Step 1: Find the relative major of C# Minor</p>
                <figure className="flex-shrink-0 flex justify-center mb-20">
                ...
                <p className="font-bold mb-6">Step 2: Apply the key signature of the relative major scale to the natural minor scale</p>
                <p className="mb-10"><span className="font-bold">E Major</span> has 4 sharps in its key signature: "F♯", "C♯", "G♯", and "D♯". Applying these to the natural minor gives us:</p>
                <figure className="flex-shrink-0 flex justify-center mb-10">
                ...
                <p className="mb-10">Here is what the <span className="font-bold">C♯ Natural Minor</span> scale looks like written down on the music staff:</p>
                <figure className="flex-shrink-0 flex flex-col justify-center items-center mb-10">
