...
export const PianoBooksFilter = ({handleInstrumentValue, handleScopeValue}) => {
        ...
        <div className="px-5 lg:px-36 xl:px-52 py-8 border-b-2 bg-gray-100 border-gray-300">
            ...
            <div className="flex">
                <label className="flex flex-col pr-8">
                    <span className="mb-2">All Piano Books</span>
                    <input 
                        type="radio" 
                        name="scope" 
                        value="all"
                ...
                <label className="flex flex-col">
                    <span className="mb-2">RCM Piano Books Only</span>
                    <input 
                        type="radio" 
                        name="scope" 
                        value="rcm"
