...
const Footer = () => {
    return ( 
        <footer className="mt-20 grid grid-cols-1 gap-y-14 md:grid-cols-2 lg:grid-cols-4 px-5 py-8 bg-gradient-to-r from-regBlue via-darkBlue to-darkBlue min-h-50 text-gray-50 font-roboto">
            <div>
            ...
            <div>
                ...
                <ul className="text-sm leading-7 font-light">
                    ...
                    <li><Link href="/about" className="hover:text-lightRed">About Us</Link></li>
