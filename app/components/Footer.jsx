...
const Footer = () => {
    return ( 
        ...
        <footer className="mt-40 px-5 lg:px-10 py-8 flex flex-col-reverse gap-y-14 md:flex-row bg-gradient-to-r from-regBlue to-lightBlue min-h-50 text-gray-50 font-roboto">
