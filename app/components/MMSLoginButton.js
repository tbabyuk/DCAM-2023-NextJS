...
export const MMSLoginButton = () => {
  ...
  return (
    <>
        <button className="mt-10 md:mt-0 p-2 rounded flex items-center border-2 border-gray-100 hover:bg-[#2FA6DF]" onClick={() => setModalIsOpen(true)}><img src="/mms_logo.png" className="w-6 me-1" />Student Portal Login</button>
